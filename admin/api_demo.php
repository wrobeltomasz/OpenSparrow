    ...
    switch ($type) {
            ...
            return [
                ...
                'views' => [
                    ...
                    'v_demo_crm_revenue_by_period' => ['schema' => 'spw_crm', 'display_name' => 'Revenue by Period', 'menu_name' => 'Revenue by Period', 'icon' => 'assets/icons/file_present.png', 'hidden' => false, 'description' => 'Invoice revenue drilled by year → month → invoice.', 'columns' => [
                        ...
                        'invoice_number' => ['display_name' => 'Invoice #', 'aggregate' => 'count'],
                        'status'         => ['display_name' => 'Status', 'aggregate' => ''],
                        'amount_net'     => ['display_name' => 'Net', 'aggregate' => 'sum'],
                        'amount_tax'     => ['display_name' => 'Tax', 'aggregate' => 'sum'],
                        'amount_total'   => ['display_name' => 'Total', 'aggregate' => 'sum'],
        ...
        case 'wms':
            return [
                ...
                'ddl' => [
                    ...
                    'CREATE OR REPLACE VIEW spw_wms.v_demo_wms_stock AS SELECT p.sku, p.name AS product, p.category, w.name AS warehouse, s.quantity, s.min_quantity, (s.quantity < s.min_quantity) AS low_stock FROM spw_wms.stock s JOIN spw_wms.products p ON p.id = s.product_id JOIN spw_wms.warehouses w ON w.id = s.warehouse_id',
                ...
                'views' => [
                    'v_demo_wms_stock' => ['schema' => 'spw_wms', 'display_name' => 'WMS Stock Overview', 'menu_name' => 'Stock', 'icon' => 'assets/icons/warehouse.png', 'hidden' => false, 'description' => 'Stock levels by product & warehouse.', 'columns' => [
        ...
        case 'tasks':
            return [
                ...
                'views' => [
                    'v_demo_tasks_summary' => ['schema' => 'spw_tasks', 'display_name' => 'Task Summary', 'menu_name' => 'Summary', 'icon' => 'assets/icons/checklist_rtl.png', 'hidden' => false, 'description' => 'Task count by project & status.', 'columns' => [
