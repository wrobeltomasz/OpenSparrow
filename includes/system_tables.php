...
function system_tables_comments_ddl(callable $ident): array
{
    ...
    return [
        ...
        "COMMENT ON COLUMN $cronLogTable.status IS 'running / success / error.'",
        ...
        "COMMENT ON COLUMN $anonymizationLogTable.status IS 'running / success / error.'",
        ...
        "COMMENT ON COLUMN $etlLogTable.status IS 'running / success / error.'",
        ...
        "COMMENT ON COLUMN $etlFlowRunLogTable.status IS 'running / success / error.'",
        ...
        "COMMENT ON COLUMN $etlFlowStepLogTable.status IS 'running / success / error.'",
