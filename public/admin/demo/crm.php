...
function demo_def_crm($conn): array
{
    return [
        ...
        'demo_comments' => [
            ...
            ['related_table' => 'deals', 'related_id' => 26, 'author' => 1, 'body' => 'Phase 2 depends on Phase 1 sign-off — do not send the quote until the migration deal is Won.'],
            ['related_table' => 'deals', 'related_id' => 26, 'author' => 0, 'body' => 'Understood, holding the quote in draft until then.'],
