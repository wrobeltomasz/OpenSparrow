...
function demo_def_crm($conn): array
{
    return [
        ...
        'dashboard_widgets' => [
            ['id' => 'demo_crm_001', 'type' => 'stat_card', 'title' => 'Companies',           'table' => 'companies',  'width' => 1, 'height' => 1, 'query' => ['type' => 'count', 'column' => 'id', 'conditions' => []], 'color' => '#553eb1', 'display_columns' => []],
            ['id' => 'demo_crm_002', 'type' => 'stat_card', 'title' => 'Contacts',            'table' => 'contacts',   'width' => 1, 'height' => 1, 'query' => ['type' => 'count', 'column' => 'id', 'conditions' => []], 'color' => '#289f6f', 'display_columns' => []],
            ['id' => 'demo_crm_004', 'type' => 'stat_card', 'title' => 'Pipeline Value',       'table' => 'deals',      'width' => 1, 'height' => 1, 'query' => ['type' => 'sum', 'column' => 'value', 'conditions' => [['col' => 'stage', 'op' => '!=', 'val' => 'Won'], ['col' => 'stage', 'op' => '!=', 'val' => 'Lost']]], 'color' => '#e2b932', 'display_columns' => []],
            ['id' => 'demo_crm_003', 'type' => 'bar_chart', 'title' => 'Deals by Stage',       'table' => 'deals',      'width' => 1, 'height' => 2, 'query' => ['type' => 'group_by', 'group_column' => 'stage',  'conditions' => []], 'color' => '#fcd34d', 'display_columns' => []],
            ['id' => 'demo_crm_005', 'type' => 'pie_chart', 'title' => 'Activities Status',    'table' => 'activities', 'width' => 2, 'height' => 2, 'query' => ['type' => 'group_by', 'group_column' => 'done',   'conditions' => []], 'color' => '#c4b5fd', 'display_columns' => []],

            ['id' => 'demo_crm_011', 'type' => 'line_chart', 'title' => 'Deals Value Over Time', 'table' => 'deals',      'width' => 1, 'height' => 2, 'query' => ['type' => 'time_series', 'x_column' => 'created_at', 'granularity' => 'month', 'agg_column' => 'value', 'agg_type' => 'sum',   'area' => true, 'conditions' => []], 'color' => '#289f6f', 'display_columns' => []],
            ['id' => 'demo_crm_012', 'type' => 'line_chart', 'title' => 'Activities Over Time',  'table' => 'activities', 'width' => 2, 'height' => 2, 'query' => ['type' => 'time_series', 'x_column' => 'created_at', 'granularity' => 'week',  'agg_column' => 'id',    'agg_type' => 'count', 'area' => true, 'conditions' => []], 'color' => '#553eb1', 'display_columns' => []],
        ],
        'calendar_sources' => [
