...
define('ERROR_LOG_PATH', (string) getenv('ERROR_LOG_PATH'));
...
define('DB_STATEMENT_TIMEOUT', (int) getenv('DB_STATEMENT_TIMEOUT'));
...
define('SESSION_COOKIE_PATH', (string) getenv('SESSION_COOKIE_PATH'));
...
define('SETUP_ENABLED', getenv('SETUP_ENABLED') === 'true');
...
define('SMTP_TIMEOUT', (int) getenv('SMTP_TIMEOUT'));
